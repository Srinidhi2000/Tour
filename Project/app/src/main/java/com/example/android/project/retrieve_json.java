                ...
                for(int i=0;i<items.length();i++)
                {
                    ...
                    String isOpen="Timing NA",rating="NA";
                        ...
                        for (int j = 0; j < address.length(); j++) {
                            if(j!=0)
                                formattedAdress=formattedAdress+" , "+address.getString(j);
                            else
                                formattedAdress=formattedAdress+address.getString(j);
                        ...
                        Place current = new Place(id,name, formattedAdress,namecat,isOpen,rating );
                        places.add(current);
                    }
...
current=new VenueDetails(name,phone,lat,lng,formattedAdress,categoryname,rating,description,status,url);
        } catch (JSONException e) {
